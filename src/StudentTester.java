...
public class StudentTester {
	...
	public static void bonusCredit()
	{
		...
		//Add players to the front row of Team A
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Cherry, Arena.Row.Front, 1);
		...
		//Add players to the Back row of Team A
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Cherry, Arena.Row.Back, 1);
